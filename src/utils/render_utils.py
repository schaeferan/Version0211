...
def normalize_disp(dataset_name):
  ...
  """Specify if disparity should be normalized for a given dataset.

      Args:
          dataset_name (str): Name of the dataset.

      Returns:
          bool: True if disparity should be normalized, False otherwise.
"""
...
def get_render_function(model, config, randomized):  # pylint: disable=unused-argument
  ...
  """Construct the rendering function.
      ...
      Args:
          model: The neural rendering model.
          config: Configuration parameters.
          randomized: Flag indicating if randomization should be applied.
