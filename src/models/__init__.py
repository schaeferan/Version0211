...
#Die Funktion prepare_example_batch wird verwendet, um einen Beispiel-Batch zu modifizieren
#und eine überflüssige Dimension zu entfernen, die aufgrund von Parallelisierung (pmapping) hinzugefügt wurde.
#Dies wird vor der Modellinitialisierung auf dem Hauptprozess durchgeführt.
...
def create_train_state(
  ...
  """
  model, variables = create_model(config, rng, example_batch)#Von oben
  params = variables['params']
  parameter_overview.log_parameter_overview(params)

#Optax verwendet, um den Optimizer zu konfigurieren.
