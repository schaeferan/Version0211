...
def get_dataset_config():
  ...
  dataset_config.num_interpolation_views = 5#self.num_ref_views
...
def get_model_config():
  ...
  model_config.num_projections = 45#127 #num of samples
